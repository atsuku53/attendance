...
<div class="index__container">
    ...
    <form class="index__form" action="/attendance/detail/{{ $attendance->id }}" method="POST">
        @csrf
            ...
            <div class="attendance-detail__block">
                <table class="attendance-detail__table">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <textarea class="table-comment__input" name="comment">{{ old('comment', $modifiedAttendance ? $modifiedAttendance->comment : $attendance->comment) }}</textarea>
                        </td>
                    </tr>
                </table>
            </div>
